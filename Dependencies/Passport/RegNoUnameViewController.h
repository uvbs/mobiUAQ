...
@interface RegNoUnameViewController : UIViewController <UITextFieldDelegate,UIScrollViewDelegate,VSapiComDelegate>{
    BOOL _isInputErr;
    CGRect _regViewRect;
    BOOL _isPassShow;
    BOOL _hasVerifyCode;
...
@property (nonatomic, retain) UIImageView* passwordViewImage;
