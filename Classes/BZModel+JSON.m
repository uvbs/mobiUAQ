...
- (NSMutableDictionary*)rootDictionary
{
	...
	return [NSMutableDictionary dictionaryWithObjectsAndKeys:
														@"1.5", @"version",
														[NSDictionary dictionaryWithObjectsAndKeys:	@"MobiUAQ", @"name",@"1.6", @"version", nil], @"creator",
			
														[NSDictionary dictionaryWithObjectsAndKeys: @"iOS - WebKit/Safari", @"name",[[UIDevice currentDevice] systemVersion], @"version", nil], @"browser",
...
- (NSDictionary*)dictionaryFromResult
{
    ...
    NSMutableDictionary *customDict = [self customDictionary];
    /*TODO*/
	[root setObject:pagesArray forKey:@"pages"];
	[root setObject:entriesArray forKey:@"entries"];
    [root addEntriesFromDictionary:customDict];
...
- (NSDictionary*)dictionaryFromResource:(NSMutableDictionary*)urlToLen
{
	...
	//JK _realBodySize is unzipped size and bodySize is zipped network transffer size
	...
	[timingDictionary setObject:[NSNumber numberWithInt:[blockedTime timeIntervalSinceDate:startTime] * 1000] forKey:@"blocked"];
	[timingDictionary setObject:[NSNumber numberWithInt:[dnsTime timeIntervalSinceDate:startTime] * 1000] forKey:@"dns"];
