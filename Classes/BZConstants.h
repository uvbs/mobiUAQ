...
#define kBZMaxJobsPerDay @"bz-max-jobs-day"
...
#define kBZLoginButton @"login_button.png"
#define kBZLoginButtonPressed @"login_button_pressed.png"
#define kBZloginBGImage @"login_bg.png"
#define kBZIdleBGImage @"idle_bg.png"
#define kBZLocationImage @"location.png"
#define kBZSettingsImage @"setttings.png"
